...
static struct reg_value ov5647_setting_30fps_960P_1280_960[] = {
	...
	{	0x3035	,	0x11	,	0	,	0	}	, // was 21
	{	0x3036	,	0x69	,	0	,	0	}	, // was 52
	{	0x303c	,	0x11	,	0	,	0	}	,
	{	0x3106	,	0xf5	,	0	,	0	}	,
	{	0x3821	,	0x07	,	0	,	0	}	,
	{	0x3820	,	0x41	,	0	,	0	}	,
...
/*static struct reg_value ov5647_setting_30fps_960_720[] = {
	...
	{	0x3c01	,	0x80	,	0	,	0	}	,
	{	0x3b07	,	0x0c	,	0	,	0	}	,
	{	0x380c	,	0x06	,	0	,	0	}	, // 6d6 = 1750
	{	0x380d	,	0xd6	,	0	,	0	}	,
	{	0x380e	,	0x03	,	0	,	0	}	, // 3d8 = 984
	{	0x380f	,	0xd8	,	0	,	0	}	,
	{	0x3814	,	0x31	,	0	,	0	}	,
	{	0x3815	,	0x31	,	0	,	0	}	,
	{	0x3708	,	0x64	,	0	,	0	}	,
	{	0x3709	,	0x52	,	0	,	0	}	,
	{	0x3808	,	0x03	,	0	,	0	}	, // 3c0 = 960
	{	0x3809	,	0xc0	,	0	,	0	}	,
	{	0x380a	,	0x02	,	0	,	0	}	, // 2d0 = 720
	{	0x380b	,	0xd0	,	0	,	0	}	,
	{	0x3800	,	0x00	,	0	,	0	}	, // 000 = 0
	{	0x3801	,	0x00	,	0	,	0	}	,
	{	0x3802	,	0x00	,	0	,	0	}	, // 000 = 0
	{	0x3803	,	0x00	,	0	,	0	}	,
	{	0x3804	,	0x0a	,	0	,	0	}	, // a3f = 2623
	{	0x3805	,	0x3f	,	0	,	0	}	,
	{	0x3806	,	0x06	,	0	,	0	}	, // 6b2 = 1714
	{	0x3807	,	0xb2	,	0	,	0	}	,
	{	0x3811	,	0x08	,	0	,	0	}	,
	{	0x3813	,	0x02	,	0	,	0	}	,
	{	0x3630	,	0x2e	,	0	,	0	}	,
...
static struct reg_value ov5647_setting_15fps_2592_1944[] = {
	{	0x0100	,	0x00	,	0	,	0	}	,
	{	0x0103	,	0x01	,	0	,	0	}	,
	{	0x3034	,	0x18	,	0	,	0	}	,  /* was 0x1A */
	{	0x3035	,	0x21	,	0	,	0	}	, // was 21
	{	0x3036	,	0x54	,	0	,	0	}	, // was 54
	{ 	0x3037	,	0x03	,	0	,	0	}	, // was 03
	{	0x303b	,	0x19	,	0	,	0	}	,
	{	0x303c	,	0x11	,	0	,	0	}	,
	{	0x3106	,	0xf5	,	0	,	0	}	,
	{	0x3821	,	0x06	,	0	,	0	}	,
	...
	{	0x3612	,	0x4b	,	0	,	0	}	,
	{	0x3618	,	0x04	,	0	,	0	}	,
	{	0x5001	,	0x01	,	0	,	0	}	, // was 01, 0, 0 {	0x5001	,	0x83	,	0	,	70	}	,
	{	0x5002	,	0x40	,	0	,	0	}	, // was 40
	{	0x5003	,	0x08	,	0	,	0	}	,
	{	0x5a00	,	0x08	,	0	,	0	}	,
	{	0x3000	,	0x00	,	0	,	0	}	,
	{	0x3001	,	0x00	,	0	,	0	}	,
	...
	{	0x3c01	,	0x80	,	0	,	0	}	,
	{	0x3b07	,	0x0c	,	0	,	0	}	,
	{	0x380c	,	0x0b	,	0	,	0	}	, // was 768
	{	0x380d	,	0x1c	,	0	,	0	}	,
	{	0x380e	,	0x07	,	0	,	0	}	, // was 3b8
	{	0x380f	,	0xb0	,	0	,	0	}	,
	{	0x3814	,	0x11	,	0	,	0	}	,
	{	0x3815	,	0x11	,	0	,	0	}	,
	{	0x3708	,	0x64	,	0	,	0	}	,
	{	0x3709	,	0x52	,	0	,	0	}	,
	{	0x3808	,	0x0a	,	0	,	0	}	, // a20 = 2592
	{	0x3809	,	0x20	,	0	,	0	}	,
	{	0x380a	,	0x07	,	0	,	0	}	, // 798 = 1944
	{	0x380b	,	0x98	,	0	,	0	}	,
	{	0x3800	,	0x00	,	0	,	0	}	, // 00c = 12
	{	0x3801	,	0x0c	,	0	,	0	}	,
	{	0x3802	,	0x00	,	0	,	0	}	, // 004 = 4
	{	0x3803	,	0x04	,	0	,	0	}	,
	{	0x3804	,	0x0a	,	0	,	0	}	, // a3f = 2623
	{	0x3805	,	0x3f	,	0	,	0	}	,
	{	0x3806	,	0x07	,	0	,	0	}	, // 79f = 1951*/
	{	0x3807	,	0x9f	,	0	,	0	}	,
	{	0x3810	,	0x00	,	0	,	0	}	,
	{	0x3811	,	0x08	,	0	,	0	}	,
	{	0x3812	,	0x00	,	0	,	0	}	,
	...
	{	0x4004	,	0x02	,	0	,	0	}	,
	{	0x4000	,	0x09	,	0	,	0	}	,
	{	0x4837	,	0x0a	,	0	,	0	}	,  // mipi clock x15 = 21
	{	0x4050	,	0x6e	,	0	,	0	}	,
	{	0x4051	,	0x8f	,	0	,	0	}	,
	{	0x0100	,	0x01	,	0	,	0	}	,
#if 0
...
static struct ov5647_mode_info ov5647_mode_info_data[2][ov5647_mode_MAX + 1] = {
	{
		...
		ov5647_setting_15fps_2592_1944,
		ARRAY_SIZE(ov5647_setting_15fps_2592_1944)},
				...
				enum ov5647_mode mode)
{
	...
	if ((binning_on()) && (mode != ov5647_mode_960P_1280_960) &&
		...
		&& (mode != ov5647_mode_QSXGA_2592_1944))
		prev_shutter *= 2;
			    ...
			    enum ov5647_mode mode, enum ov5647_mode orig_mode)
{
	...
	s32 rval1, rval2, rval3, rval4;
	int rdresX, rdresY, rtresX, rtresY;

	// Yuefeng
	pr_err("parameters are: framerate = %x, mode = %x, orgmode = %x\n", frame_rate, mode, orig_mode);
	// Yuefeng
	...
	if (mode == ov5647_mode_INIT) {
		...
		// Yuefeng
		pr_err("init parameters set to: framerate = %x, mode = %x\n", frame_rate, index);
		// Yuefeng
	...
	// Yuefeng
		rval1 = ov5647_read_reg(0x3808, &val1);
		rval2 = ov5647_read_reg(0x3809, &val2);
		rval3 = ov5647_read_reg(0x380a, &val3);
		rval4 = ov5647_read_reg(0x380b, &val4);

		rdresX = val1*16*16 + val2;
		rdresY = val3*16*16 + val4;
		rtresX = rval1*16*16 + rval2;
		rtresY = rval3*16*16 + rval4;

		pr_err("In Init_mod_function, Registers are set at 0x3808=%x(%x), 0x3809=%x(%x), 0x380a=%x(%x), 0x380b=%x(%x)\n", 
			val1, rval1, val2, rval2, val3, rval3, val4, rval4);
		pr_err("In Init_mod_function, Resolution is set at %dx%d (%dx%d)\n", rdresX, rdresY, rtresX, rtresY);
	// Yuefeng
	...
	if (mipi_csi2_info) {
		...
		while (1) {
			...
			if (!mipi_reg)
				break;
			if (i++ >= 20) {
				pr_err("mipi csi2 can not receive data correctly! %x\n", mipi_reg);
				return -1;
			}
			msleep(10);
		}
...
static int ioctl_s_parm(struct v4l2_int_device *s, struct v4l2_streamparm *a)
{
	...
	case V4L2_BUF_TYPE_VIDEO_CAPTURE:
		...
		// Yuefeng add those lines
		//timeperframe->denominator = DEFAULT_FPS;
		//timeperframe->numerator = 1;
		// a->parm.capture.capturemode = 2;
		// Yuefeng end
		...
		pr_err("ioctl: Registers are set at 0x3808=%x(%x), 0x3809=%x(%x), 0x380a=%x(%x), 0x380b=%x(%x)\n", 
			val1, rval1, val2, rval2, val3, rval3, val4, rval4);
		pr_err("ioctl: Resolution is set at %dx%d (%dx%d)\n", rdresX, rdresY, rtresX, rtresY);
		// Yuefeng
